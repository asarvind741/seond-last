...
@Component({
  selector: 'app-edit-restful',
  templateUrl: './edit-restful.component.html',
  styleUrls: ['./edit-restful.component.scss']
})
export class EditRestfulComponent implements OnInit {
